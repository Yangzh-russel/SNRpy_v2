...
for q in range(len(sat_lis)):
    ...
    while True:
        ...
        if int(sat) == int(datos[2]) and float(datos[4]) > el_min and float(datos[4]) < el_max and float(
                datos[5]) > azi_min and float(datos[5]) < azi_max:
        ...
        if len(el_lis) > (30 * 60 / int_tiempo) and (max(el_lis) - min(el_lis)) > inc_eleva:
            ...
            for s in range(len(e_lis1)):
                if s == 0:
                    ...
                    salida.write(str(e_lis1[s]) + ' ' + buena + ' ' + str(h_lis[s].strip()) + ' ' + str(
                        year_lis[s].strip()) + ' ' + str(mes_lis[s].strip()) + ' ' + str(
                        dia_lis[s].strip()) + ' ' + str(sat.strip()) + ' ' + str(ini_azi) + ' ' + str(
                        fin_azi) + ' ' + str(ini_ele) + ' ' + str(fin_ele) + ' ' + str((a0)) + ' ' + str(
                        desv_A) + ' ' + str(phase) + ' ' + str(desv_p) + ' ' + str(round(rh, 3)) + ' ' + str(
                        direction) + '\n')
                    if buena == "yes":
